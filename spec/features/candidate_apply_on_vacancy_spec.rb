...
feature 'Candidate view all vacancies' do
  scenario 'successfully' do
    ...
    candidate = Candidate.create!(user: user, college: 'Universidade de São Paulo', 
                                  wins: 'Projeto em Ruby on Rails link: https://github.com/LucasR2D2S/job_website',
                                  biography: 'Me formei em tecnologia para ajudar as pessoas e tenho um interesse 
                                  em Front-End.')
    login_as user, scope: :user
    company = Company.create!(name: 'Rebase', cnpj: '42.318.949/0001-84', address: 'Rua da Rebase, 1234', company_email: 'rebase.com.br')
    vacancy = Vacancy.create!(title: 'Desenvolvedor Jr. Ruby on Rails', 
                              company_name: 'Rebase', num_candidates: 5, salary: 2500, local: 'São Paulo', 
